...
<body>
    ...
    <div class="profile-page">
        <a href="<?= ($_SESSION['level'] == 'admin')
            ? 'admin/pages/dashboard-utama.php'
            : 'index.php'; ?>" class="back-button">
            ←
        </a>
        <div class="profile-card">
            <div class="profile-left">
                <img src="uploads/pfp/<?= htmlspecialchars($user['foto']); ?>" class="profile-photo">
